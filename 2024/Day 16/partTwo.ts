// works on examples, but is not optimal for puzzle input
...
let obj: Record<number, Record<string, boolean>> = {};

moveReindeer(0, {}, reindeerDirection, reindeer);

console.log(Object.keys(obj[lowestScore]).length + 1);
...
function moveReindeer(
  ...
  if (map[simulatedReindeer[0]][simulatedReindeer[1]] === "E") {
    ...
    if (score === lowestScore) {
      obj[lowestScore] = { ...obj[lowestScore], ...reindeerTrail };
    }
    return;
  }
